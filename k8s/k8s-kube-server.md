...
`k8s.io/kubernetes/cmd/kube-apiserver/app/server.go:159`
...
`k8s.io/kubernetes/cmd/kube-apiserver/app/server.go:177`
...
在 `CreateKubeAPIServerConfig` 中主要是调用 `buildGenericConfig` 创建 genericConfig 以及构建 controlplane.Config 对象。

`k8s.io/kubernetes/cmd/kube-apiserver/app/server.go:236`
...
`k8s.io/kubernetes/cmd/kube-apiserver/app/server.go:353`
...
`k8s.io/kubernetes/cmd/kube-apiserver/app/apiextensions.go:103`
...
`k8s.io/kubernetes/staging/src/k8s.io/apiextensions-apiserver/pkg/apiserver/apiserver.go:130`
